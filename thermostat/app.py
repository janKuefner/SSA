...
class Thermometer:
    ...
    def __init__(self, set_temperature, current_temperature, payload):
        ...
        heating is set to'''
        self.set_temperature = set_temperature  # current set temperature
        self.current_temperature = current_temperature  # current measured temp
    ...
    def create_payload(self):
        ...
        '''create the payload as per convention so others can read what was
        sent by this node'''
...
print("Success. MQTTS started")  # provide feedback on GUI

'''main part of the programm. Loops through iterative steps of the node'''
while True:  # loop forever
    '''subscribe via QoS1, since higher quality is needed, since the thermo
    revceives set signals from controller, which need high assurance, that they
    are received'''
